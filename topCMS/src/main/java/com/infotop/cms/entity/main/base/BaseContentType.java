...
/**
 * This is an object that contains data related to the tc_content_type table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="tc_content_type"
 */
...
public abstract class BaseContentType  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.infotop.cms.entity.main.ContentType)) return false;
		else {
			com.infotop.cms.entity.main.ContentType contentType = (com.infotop.cms.entity.main.ContentType) obj;
