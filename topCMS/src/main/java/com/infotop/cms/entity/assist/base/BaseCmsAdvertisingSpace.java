...
/**
 * This is an object that contains data related to the tc_advertising_space table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="tc_advertising_space"
 */
...
public abstract class BaseCmsAdvertisingSpace  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.infotop.cms.entity.assist.CmsAdvertisingSpace)) return false;
		else {
			com.infotop.cms.entity.assist.CmsAdvertisingSpace cmsAdvertisingSpace = (com.infotop.cms.entity.assist.CmsAdvertisingSpace) obj;
