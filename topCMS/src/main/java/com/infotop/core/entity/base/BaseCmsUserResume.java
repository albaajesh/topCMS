...
/**
 * This is an object that contains data related to the tc_user_resume table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="tc_user_resume"
 */
...
public abstract class BaseCmsUserResume  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.infotop.core.entity.CmsUserResume)) return false;
		else {
			com.infotop.core.entity.CmsUserResume cmsUserResume = (com.infotop.core.entity.CmsUserResume) obj;
